...
export const presets = {
	...
	mathTerms2: {
		...
		values: [
			...
			{"str": "Differentialgleichung", "desc": "Gleichung, die Ableitungen einer unbekannten Funktion beinhaltet"},
			...
			{"str": "Kreis", "desc": "Geometrische Figur mit allen Punkten, die einen konstanten Abstand zu einem Mittelpunkt haben"},
			{"str": "Polynom", "desc": "Algebraischer Ausdruck mit Summen von Potenzen einer Variablen"},
			{"str": "Quadratwurzel", "desc": "Eine Zahl, die multipliziert mit sich selbst das Argument ergibt"},
			{"str": "Stetigkeit", "desc": "Eigenschaft einer Funktion, bei der kleine Änderungen im Argument kleine Änderungen im Funktionswert verursachen"},
			{"str": "Trigonometrie", "desc": "Studium der Beziehungen zwischen den Seiten und den Winkeln von Dreiecken"},
			{"str": "Axiom", "desc": "Grundlegende Annahme, die in einem mathematischen System gilt"},
			{"str": "Kongruenz", "desc": "Beziehung zwischen geometrischen Figuren, bei der sie in Form und Größe übereinstimmen"},
			...
			{"str": "Kreuzprodukt", "desc": "Produkt zweier Vektoren, das einen Vektor ergibt, der senkrecht zu den Ausgangsvektoren steht"},
			...
			{"str": "Primzahl", "desc": "Eine natürliche Zahl größer als 1, die nur durch 1 und sich selbst ohne Rest teilbar ist"},
			...
			{"str": "Hyperbel", "desc": "Geometrische Kurve, die durch die Gleichung xy = k charakterisiert wird"},
			{"str": "Logarithmus", "desc": "Die Potenz, zu der eine bestimmte Zahl erhöht werden muss, um eine andere Zahl zu ergeben"},
			{"str": "Normalverteilung", "desc": "Wahrscheinlichkeitsverteilung, die durch eine Glockenkurve gekennzeichnet ist"},
			...
			{"str": "Stochastik", "desc": "Bereich der Mathematik, der sich mit zufälligen Ereignissen befasst"},
			...
			{"str": "Analysis", "desc": "Teilgebiet der Mathematik, das sich mit Funktionen und deren Eigenschaften befasst"},
			{"str": "Basis", "desc": "Grundlegende Menge von Vektoren, die einen Vektorraum aufspannen"},
			{"str": "Definitheit", "desc": "Eigenschaft einer quadratischen Form, positiv, negativ oder indefinit zu sein"},
			{"str": "Ellipse", "desc": "Geometrische Kurve, die durch die Gleichung x²/a² + y²/b² = 1 charakterisiert wird"},
			{"str": "Fraktal", "desc": "Komplexe geometrische Form, die sich aus einfachen Mustern wiederholt"},
			{"str": "Gradient", "desc": "Vektor, der die Richtung des steilsten Anstiegs einer Funktion angibt"},
			...
			{"str": "Manifold", "desc": "Mathematischer Raum, der lokal flach ist, aber global gekrümmt sein kann"},
			...
			{"str": "Rekursion", "desc": "Mathematisches Konzept, bei dem eine Funktion sich selbst aufruft"},
	...
	computerScienceTerms: {
		...
		aiGenerated: true,
		values: [
			{"str": "Algorithmus", "desc": "Eine präzise Reihe von Anweisungen zur Lösung eines Problems in endlicher Zeit."},
			{"str": "Array", "desc": "Eine Datenstruktur, die eine Sammlung von Elementen desselben Typs speichert und über einen Index zugänglich macht."},
			{"str": "Variable", "desc": "Ein Bezeichner, der einen Wert speichert und sich während der Programmausführung ändern kann."},
			{"str": "Funktion", "desc": "Ein in sich geschlossener Block von Anweisungen, der eine bestimmte Aufgabe ausführt."},
			{"str": "Schleife", "desc": "Eine Kontrollstruktur, die es ermöglicht, einen Block von Anweisungen mehrmals auszuführen, solange eine Bedingung erfüllt ist."},
			{"str": "Rekursion", "desc": "Ein Konzept, bei dem eine Funktion sich selbst aufruft, um eine Aufgabe zu lösen."},
			{"str": "Klasse", "desc": "Ein Bauplan zur Erstellung von Objekten, der Eigenschaften und Methoden definiert."},
			{"str": "Objekt", "desc": "Eine Instanz einer Klasse, das Daten und Methoden zur Bearbeitung dieser Daten enthält."},
			{"str": "Interface", "desc": "Eine Sammlung von Methoden, die von Klassen implementiert werden müssen, um eine bestimmte Funktionalität bereitzustellen."},
			{"str": "Methode", "desc": "Eine Funktion, die einem Objekt zugeordnet ist und darauf zugreifen kann."},
			{"str": "Datenbank", "desc": "Ein strukturierter Satz von Daten, der in einem Computersystem gespeichert ist und abgerufen sowie aktualisiert werden kann."},
			{"str": "SQL", "desc": "Structured Query Language, eine Sprache zur Verwaltung und Abfrage von Datenbanken."},
			{"str": "HTML", "desc": "Hypertext Markup Language, eine Auszeichnungssprache zur Strukturierung von Inhalten im Web."},
			{"str": "CSS", "desc": "Cascading Style Sheets, eine Stylesheet-Sprache zur Gestaltung des Aussehens von HTML-Dokumenten."},
			{"str": "JavaScript", "desc": "Eine Skriptsprache, die hauptsächlich für die Entwicklung von interaktiven Webseiten verwendet wird."},
			{"str": "API", "desc": "Application Programming Interface, eine Schnittstelle, die den Zugriff auf die Funktionalität eines Programms ermöglicht."},
			{"str": "JSON", "desc": "JavaScript Object Notation, ein Datenformat zum Speichern und Austauschen von Daten."},
			{"str": "XML", "desc": "Extensible Markup Language, eine Auszeichnungssprache zur Darstellung hierarchischer Strukturen in Textform."},
			{"str": "TCP", "desc": "Transmission Control Protocol, ein zuverlässiges, verbindungsorientiertes Protokoll zur Übertragung von Daten über ein Netzwerk."},
			{"str": "IP", "desc": "Internet Protocol, ein Protokoll zur Adressierung und zum Routing von Datenpaketen über ein Netzwerk."},
			{"str": "HTTP", "desc": "Hypertext Transfer Protocol, ein Protokoll zur Übertragung von Daten über das World Wide Web."},
			{"str": "FTP", "desc": "File Transfer Protocol, ein Netzwerkprotokoll zum Übertragen von Dateien über ein TCP/IP-Netzwerk."},
			{"str": "LAN", "desc": "Local Area Network, ein Netzwerk, das eine begrenzte geografische Fläche wie ein Gebäude oder eine Gruppe von Gebäuden abdeckt."},
			{"str": "Router", "desc": "Ein Netzwerkgerät, das den Datenverkehr zwischen verschiedenen Netzwerken steuert und weiterleitet."},
			{"str": "Firewall", "desc": "Ein Sicherheitssystem, das den Datenverkehr zwischen einem internen Netzwerk und dem Internet überwacht und filtert."},
			{"str": "Betriebssystem", "desc": "Eine Software, die die Ressourcen eines Computers verwaltet und die Ausführung von Anwendungsprogrammen ermöglicht."},
			{"str": "Compiler", "desc": "Ein Programm, das Quellcode in ausführbaren Code übersetzt."},
			{"str": "Interpreter", "desc": "Ein Programm, das Quellcode Zeile für Zeile liest und sofort ausführt."},
			{"str": "Debugging", "desc": "Der Prozess der Identifizierung und Behebung von Fehlern oder Fehlfunktionen in einem Computerprogramm."},
			{"str": "Versionierung", "desc": "Das Verwalten und Verfolgen von Änderungen an Dokumenten, Dateien oder Software über die Zeit."},
			{"str": "Repository", "desc": "Ein Speicherort, der alle Versionen einer Software oder einer Gruppe von Dateien sowie Metadaten darüber enthält."},
			{"str": "Framework", "desc": "Eine strukturierte Sammlung von Bibliotheken, Werkzeugen und Best Practices zur Entwicklung von Softwareanwendungen."},
			{"str": "Client", "desc": "Ein Computer oder eine Softwareanwendung, die auf Dienste oder Ressourcen in einem Netzwerk zugreift."},
			{"str": "Server", "desc": "Ein Computer oder ein Programm, das Dienste oder Ressourcen für andere Computer oder Programme bereitstellt."},
			{"str": "Virtualisierung", "desc": "Die Erstellung virtueller Versionen von Ressourcen wie Hardware, Betriebssystemen oder Speichermedien."},
			{"str": "Container", "desc": "Eine standardisierte, ausführbare Umgebung, die Anwendungen und ihre Abhängigkeiten kapselt."},
			{"str": "Kryptographie", "desc": "Das Studium und die Anwendung von Techniken zum Schutz von Informationen vor unbefugtem Zugriff oder Änderung."},
			{"str": "Cybersecurity", "desc": "Der Schutz von Computersystemen, Netzwerken und Daten vor Cyberangriffen."},
			{"str": "Blockchain", "desc": "Eine dezentrale, verteilte Datenbanktechnologie, die Transaktionen transparent und sicher speichert."},
			{"str": "DevOps", "desc": "Eine Kultur und Praktik, die die Zusammenarbeit zwischen Entwicklungsteams und Betriebsteams fördert, um Softwareentwicklung und Bereitstellung zu verbessern."},
			{"str": "Agile", "desc": "Ein Ansatz für Softwareentwicklung, der iterative Entwicklung, Zusammenarbeit und schnelle Anpassung betont."},
			{"str": "Microservices", "desc": "Eine Architektur, bei der eine Anwendung als eine Sammlung kleiner, unabhängiger Dienste entwickelt und bereitgestellt wird."},
			{"str": "REST", "desc": "Representational State Transfer, ein Architekturstil für verteilte Systeme, der auf HTTP basiert und Ressourcen über URLs darstellt."},
			{"str": "Encryption", "desc": "Das Verfahren, Daten in eine Form umzuwandeln, die nur autorisierte Parteien lesen können."},
			{"str": "OAuth", "desc": "Ein Autorisierungsprotokoll, das es einem Benutzer ermöglicht, Ressourcen freizugeben, ohne seine Anmeldeinformationen weiterzugeben."},
			{"str": "Regex", "desc": "Ein regulärer Ausdruck, eine Sequenz von Zeichen, die ein Suchmuster definieren."},
			{"str": "Shell", "desc": "Eine Benutzerschnittstelle für den Zugriff auf Betriebssystemdienste, die über eine Befehlszeile oder grafische Benutzeroberfläche erfolgen kann."}
		].sort((a, b) => a.str.localeCompare(b.str))
	}
