...
const presets = {
	...
	model: {
		name: 'Modell',
		colors: [
			0xa4a037, 0x9c7c9d, 0xf98756, 0xbeabba, 0x7e527a, 0xe96c4c, 0x72dfcc, 0xc46f68, 0x99cdc2,
			0x15b1ab, 0x6e5060, 0x00a9f5, 0x00a3ea, 0xbba78c, 0xa9c9c2, 0xff866f, 0x80908f, 0x6399a4,
			0xff6161, 0xbcbcbe, 0xe292c7, 0xdd2e61, 0xc99eae, 0xc5d985, 0xa4a9ab, 0xffb57e, 0x128765,
			0x262722, 0xcad5d7, 0xf8ec00, 0xa8acad, 0xdf9969, 0xeabe76, 0x82ae93, 0x78b4b7, 0x00ade7,
			0x7adc2e, 0x9ccb2f, 0x5e6968, 0xf09690, 0xe44174, 0xdb774e, 0x585b44, 0x00cbab, 0xeb4a40,
			0xf2c166, 0xfe928e, 0xd6abd7, 0xff8f43, 0xa2a270, 0xbfa797, 0xea7532, 0xa3b144, 0xe3eee9,
			0x6c7175
		]
			.map(RgbColor.fromNumeric)
			.map((c) => c.color())
	},
	model2: {
		name: 'Modell 2',
		colors: [
			0x6c4c6d, 0xae9baa, 0xc46f68, 0x55ada2, 0x05716b, 0x4e3040, 0x00a9f5, 0x496962, 0xff866f,
			0x80908f, 0x6399a4, 0xff6161, 0xacacce, 0xe292c7, 0xdd2e61, 0x893e4e, 0xc5d985, 0xffb57e,
			0x128765, 0x262722, 0xcad5d7, 0xf8ec00, 0xdf9969, 0xeabe76, 0x78b4b7, 0x0073ca, 0x7adc2e,
			0x9ccb2f, 0x3e3938, 0xf09690, 0xe44174, 0x585b44, 0x00cbab, 0xeb4a40, 0xd6abd7, 0xff8f43,
			0xa2a270, 0xbfa797, 0xea7532, 0xa3b144, 0xe3eee9, 0x6c7175
		]
			.map(RgbColor.fromNumeric)
			.map((c) => c.color())
			.map((c) => NamedColor.fromColor(c, c.rgb().numeric().toString(16)))
	},
	models: {
		name: 'Modell sortiert',
		colors: [
			0xf8ec00, 0x7adc2e, 0x9ccb2f, 0xa3b144, 0xa2a270, 0xc46f68, 0xdf9969, 0xff8f43, 0xea7532,
			0xeb4a40, 0xdd2e61, 0xe44174, 0xff6161, 0xff866f, 0xf09690, 0xffb57e, 0xeabe76, 0xc5d985,
			0xbfa797, 0xae9baa, 0xe292c7, 0xd6abd7, 0xe3eee9, 0xcad5d7, 0xacacce, 0x78b4b7, 0x55ada2,
			0x6399a4, 0x80908f, 0x6c7175, 0x6c4c6d, 0x893e4e, 0x4e3040, 0x262722, 0x3e3938, 0x585b44,
			0x496962, 0x128765, 0x5716b, 0x73ca, 0xa9f5, 0xcbab
		]
			.map(RgbColor.fromNumeric)
			.map((c) => c.color())
			.map((c) => NamedColor.fromColor(c, c.rgb().numeric().toString(16)))
