...
>
	<div>
		<div class="text-2xl text-white mx-2 mt-2">Namensliste auswählen</div>
		<div class="m-4 flex-row gap-4 flex text-gray-300 bg-white bg-opacity-10 p-2 rounded">
			...
			{#each availableColorNameLists as colorNameList}
				<button
					class={` bg-gray-${
						...
						colorNameList == value ? 600 : 700
					} m-2 p-2 rounded text-${colorNameList == value ? 'white' : 'gray-200'}`}
